...
public static class AssertionHelper
{
    ...
    public static bool EntityMatchesResponse(Password entity, CreatePassword.Request response)
    {
        if (entity is null)
            return false;
        if (response is null)
    ...
    public static bool EntityMatchesResponse(Password entity, CreatePassword.Response response)
    {
        if (entity is null)
            return false;
        if (response is null)
